...
iface_input = input("Enter the network interface (e.g., eth0, wlan0, wlo1): ")
...
for ip_add in possible_ips:
    ...
    ip = IP(src="0.0.0.0", dst="255.255.255.255")  # Source IP 0.0.0.0, destination IP broadcast address
    ...
    dhcp = DHCP(
        options=[("message-type", "discover"),
                 ...
                 ("server-id", "192.168.1.249"),  # You may need to adjust this based on your environment
                 ('end')])
